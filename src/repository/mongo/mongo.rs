use crate::data::schema::UpdateUserSchema;
use crate::utils::error::MyError;
use crate::utils::response::{SingleUserResponse, UserData, UserListResponse, UserResponse};
use crate::{
    data::{model::UserModel, schema::RegisterUser},
    utils::error::MyError::*,
};
use chrono::prelude::*;
...
impl DB {
    ...
    pub async fn create_user(&self, body: &RegisterUser) -> Result<SingleUserResponse> {
    ...
    fn create_user_document(&self, body: &RegisterUser) -> Result<bson::Document> {
